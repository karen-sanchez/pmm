/*
Theme Name: ButterElixir

Theme URI:http://butterelixir.com

Author: NXTFactor 

Author URI: http://nxtfactor.com

Description: NXTFactor is a full service digital development & marketing firm. We develop customized digital platforms and marketing solutions for our valued clients. For more information please call 844-NXT-IDEA or email info@nxtfactor.com.
*/
...
::-webkit-scrollbar-thumb {
    ...
    /*background: linear-gradient(top, #70269f, #35eef6);*/	    background: linear-gradient(top, #70269f, #35eef6);		background-color: #f9f5ba !important;
}
...
.circle, .flickr_list li:hover, .dribbble_feed li:hover, .owl-pagination > .owl-page, input[type="radio"] + label:after, input[type="radio"] + label:before, img.avatar {
...
.d_none,
/**/
/*this element is should be enable. temporary disable.*/

.sticky_menu #side_menu, .sticky_menu #open_side_menu {
    display: none;
}
.p_15 {
  padding: 15px;
...
mark, #open_switcher, .bg_color_blue, .tabs_nav .ui-state-active a, .tabs_nav .active a, .owl-pagination > .active, .bg_color_blue_hover:hover, .p_table.bg_color_blue_hover.active, [class*="icon_wrap_"].animation_fill.color_scheme:before {
    background: ##ffffcb;
}
.translucent_bg_color_scheme, .translucent_bg_color_scheme.image_fixed:before {
    background-color: rgba(65, 190, 221, .7);
}
.tabs_nav .active a, .tabs_nav .ui-state-active a, .accordion_item.active, .owl-pagination > .active, .p_table.bg_color_blue_hover:hover, .p_table.bg_color_blue_hover.active, .dropdown .sub_menu, .color_scheme_hover:not(.color_light):hover, .color_scheme_hover:hover [class*="color_"], .dropdown_2_container.login:hover > [class*="icon_wrap_"] {
    border-color: #ffffcb;
}
...
.tabs_nav .ui-state-active + li a, .tabs_nav .active + li a {
...
.bg_light_2, .sub_menu li:hover > a, .sub_menu .current > a, table:not(.table_type_9) tr:hover, .categories_list ul a:hover, .sub_menu .current_click > a {
    background: #f7f9f9;
}
...
blockquote.type_2 {
	/*background: #ecf0f1; */		border: 1px solid #ffffff;
}
...
.gradient_line {
    ...
    position: absolute;
    top: 0;
}.header_top_part .t_xs_align_c li span{	color: #333;	}
.header_top_part .t_xs_align_c li{	float:none !important;		text-align:center;}
.header_top_part .col-lg-6{	width:100% !important;}.header_top_part .t_align_r{	display:none;}
.header_top_part {
    background:#f9f5ba;		color:#000000;		padding: 6px 0 8px;
    position: relative;
    z-index: 999;
}
...
div.main_menu > ul > li.menu_notice_box,
...
.main_menu > li:hover > a:after, .main_menu > .current-menu-item > a:after {
    opacity: 1;
...
.main_menu .current-menu-ancestor.menu-item-depth-0 > a, .main_menu .menu-item-depth-0.current-menu-item > a {
    background-color: transparent;
}

/* Menu Label*/

.main_menu li .menu-label {
  font-size: 13px;
  line-height: 19px;
  padding: 0 5px;
  position: absolute;
...
.main_menu .sub_menu li > a > span > .menu-label{
  display: inline-block;
  margin-left: 2px;
  padding: 0 4px;
  vertical-align: top;
}
.main_menu > li > a > span > .pin-bottom:before {
...
.main_menu > li > a > span > .label1.pin-bottom:before {
  border-top-color: #5bd2ec;
}
.main_menu > li > a > span > .label2.pin-bottom:before {
...
.blog_paginations.paginations li, .paginations li a {
    width: 39px;
    height: 35px;
    line-height: 32px;
    display: block;
...
.blog_paginations.paginations li:last-child, .paginations li:last-child a {
    border-right: 1px solid #bdc3c7;
}
.paginations.blog_paginations > li:first-child, .paginations li:first-child a {
    border-radius: 4px 0 0 4px;
}
.paginations.blog_paginations > li:last-child, .paginations li:last-child a {
    border-radius: 0 4px 4px 0;
}
.blog_paginations.paginations li {
    width: auto;
}
.blog_paginations.paginations li > span, .blog_paginations.paginations li a {
    border: medium none;
    display: block;
    height: auto;
    line-height: normal;
...
.flickr_list li:nth-child(3n), .dribbble_feed li:nth-child(3n){
	margin-right: 0px;
}
...
a.checkout-button.button,
[class*="button_type"], .shop_table.cart .coupon input[type="submit"], .shop_table.cart .actions input.checkout-button, .shop_table.cart .actions input[name="update_cart"], .shipping-calculator-form button[name="calc_shipping"], .place-order input[name="woocommerce_checkout_place_order"], .woocommerce .login .form-row input[name="login"], .woocommerce .lost_reset_password input[name="wc_reset_password"], .woocommerce-account .woocommerce input[name="save_account_details"], .woocommerce-account .woocommerce input[name="save_address"], a.added_to_cart {
    border-width: 1px;
    border-style: solid;
    padding-left: 29px;
    padding-right: 29px;
...
.button_type_4, .place-order input[name="woocommerce_checkout_place_order"] {
    padding-top: 19px;
    padding-bottom: 20px;
}
.button_type_5, a.added_to_cart {
    min-height: 40px;
...
.paginations a:hover i[class|="icon"], .paginations .active a i[class|="icon"]{
	color: #fff;
}
...
.hide, .search_buttons > button, [class*="select_button"]:before, [class*="select_button"]:hover:after, .rating_list li > [class|="icon"]:last-child, .rating_list .active > [class|="icon"]:first-child, .accordion_item dt [class*="icon_wrap"]:first-child, .accordion_item.active dt [class*="icon_wrap"]:nth-child(2) {
    opacity: 0;
}

/*.fp_item:hover .fp_images a img{
...
.fp_item .fp_images a img:not(.attachment-shop_catalog) {
    opacity: 0;
...
.fp_item:hover .fp_images a img:not(.attachment-shop_catalog) {
    opacity: 1;
    position: relative;
    z-index: 2;
}
...
.page-id-4342 .section_offset {
  background-image: url("https://www.butterelixir.com/wp-content/uploads/2014/10/background.png");
}
.page-id-312 .section_offset {
  padding-top: 0px;
}
/*.page-id-312 .wpb_wrapper{
	margin-top:40px;
}*/
...
.side_main_menu .has_sub_menu > a > i.menu_toggle
{    
    display: block;
    font-style: normal;
    position: absolute;
...
.vertical_animate_finished, .main_menu li:hover > .mega_menu_container, .mega_menu_container .container3d:hover .sub_menu, .no_children_animate [class*="animate_f"] {
...
.fp_item .fp_buttons .w_md_full {
  width: auto;
}

.fp_item .fp_buttons .w_md_full:first-child {
  display: block;
  float: none;
  margin: 0 auto;
  transform: translateX(0px);
...
.blog_post img, .illusions_post .gallery_slider, .illusions_post img {
    max-width: 100%;
    height: auto;
}
.post-thumb iframe {
...
.relative.r_corners.d_xs_inline_b.d_mxs_block.wrapper.m_bottom_23 {
    text-align: left;
}
...
.product-details-conteiner .product_view {
    width: 42%;
}
...
.paginations li div[class*="rc_"] > a {
    border: medium none;
    height: 33px;
    line-height: 30px;
    border-radius: 0;
}
.paginations li div[class*='rc_'] {
    border: 1px solid #bdc3c7;
    border-right: none;
}

.paginations li div[class*='rc_']:hover {
	border-color: #4E4CA0;
}

.paginations li div.rc_last_hr {
    border: 1px solid #bdc3c7;
}
.wpb_row {
    display: inline-block;
...
.section_offset .wpb_content_element.wpb_tabs .wpb_tour_tabs_wrapper .wpb_tab {
    background-color: transparent;
    padding-left: 0;
}
...
.section_offset .wpb_content_element .wpb_tabs_nav li, .section_offset .wpb_tabs .wpb_tabs_nav li {
    float: left;
    background: none;
...
.section_offset .wpb_content_element .wpb_tabs_nav li:first-child, .section_offset .wpb_tabs .wpb_tabs_nav li:first-child {
    border-radius: 4px 0 0 4px;
    border-left: 1px solid #000000;
}
.section_offset .wpb_content_element .wpb_tabs_nav li:last-child, .section_offset .wpb_tabs .wpb_tabs_nav li:last-child {
    border-radius: 0 4px 4px 0;
}
.section_offset .wpb_content_element .wpb_tabs_nav li.ui-tabs-active, .section_offset .wpb_tabs .wpb_tabs_nav li.ui-tabs-active {
    border-color: #41bedd;
}
.section_offset .wpb_content_element .wpb_tour_tabs_wrapper .wpb_tabs_nav a {
    padding: 9px 20px 10px;
    color: #34383d;
}
.section_offset .wpb_content_element .wpb_tour_tabs_wrapper .wpb_tabs_nav li.ui-tabs-active a {
    background: none repeat scroll 0 0 #41bedd;
    color: #000;
}
.r_corners img {
    border-radius: 4px;
...
.t_align_c .tabs_nav> li {
    float: left;
}*/

.vc_separator.services_separator .vc_sep_line {
    border-color: transparent;
}
.fp_nav_prev {
    left: -5%;
...
.tagcloud a {
    ...
    border-radius: 4px;
    display: inline-block;
    transition: color 1.1s ease 0s, background-color 1.1s ease 0s, border-color 1.1s ease 0s;
}
.tagcloud a:hover {
    border-color: #a255c4;
    color: #a255c4;
...
/*.product-details-conteiner .tabs_nav > li {
    float: left;
}*/
...
.widget_swpf-related-products-widget h5.fw_light {
    float: left;
}
.product-details-conteiner p.price {
    border-bottom: 1px solid #ecf0f1;
    margin-bottom: 0;
    padding-bottom: 15px;
}
...
.product-details-conteiner form.cart {
    display: inline-block;
}
.product-details-conteiner .product_meta {
    border-top: 1px solid #ecf0f1;
    margin-top: 15px;
    padding-top: 5px;
}
/*.widget_popular_posts_tab .tabs_nav > li {
    display: inline-block;
    float: left;
}*/
.blog_listing .gallery_slider img {
    height: auto;
}
...
#breaking_news .single_breaking_news {
    max-height: 25px;
}
.wpb_button {
    text-shadow: none;
...
/*.shop_table.cart tr:first-child td, .shop_table.cart tr:first-child th{
	border: 1px solid #bdc3c7;
}

.shop_table.cart tr td:first-child, .shop_table.cart tr th:first-child{
	border: 1px solid #bdc3c7;
}

.shop_table.cart tr td:last-child, .shop_table.cart tr th:last-child{
	border: 1px solid #bdc3c7;
}*/

.shop_table.cart label[for="coupon_code"] {
...
.shop_table.cart .coupon input[type="submit"] {} .shop_table.cart .actions input.checkout-button, .shop_table.cart .actions input[name="update_cart"] {
    margin: 4px 2px;
}
...
.woocommerce .cart-collaterals .cart_totals, .woocommerce .cart-collaterals {
/*    overflow: hidden;*/
}
...
.woocommerce .cart-collaterals .cart_totals > h2, .woocommerce .cart-collaterals .shipping_calculator > h2, .woocommerce .cart-collaterals .cross-sells > h2, .woocommerce-wishlist.woocommerce #yith-wcwl-form > h2, .woocommerce-wishlist.woocommerce .yith-wcwl-share > h4{
    padding: 12px 20px 14px 70px;
    font-size: 1.5em;
    position: relative;
    background: #f7f9f9;
...
.woocommerce .cart-collaterals .cart_totals > h2:before, .woocommerce .cart-collaterals .shipping_calculator > h2:before, .woocommerce .cart-collaterals .cross-sells > h2:before, .woocommerce-wishlist.woocommerce #yith-wcwl-form > h2:before, .woocommerce-wishlist.woocommerce .yith-wcwl-share > h4:before {
    content: '\e914';
    font-family: "fontello";
    font-style: normal;
    font-weight: normal;
...
/*.cart_totals table tr td:first-child, .cart_totals table tr th:first-child{
	border: 1px solid #bdc3c7;
}

.cart_totals table tr:first-child td, .cart_totals table tr:first-child th{
	border: 1px solid #bdc3c7;
}

.cart_totals table tr td:last-child, .cart_totals table tr th:last-child, .cart_totals table tr:last-child td{
	border: 1px solid #bdc3c7;
}*/
...
.woocommerce .cart-collaterals .shipping_calculator .country_to_state, .woocommerce .cart-collaterals .shipping_calculator #calc_shipping_state {
    border: 1px solid #bdc3c7;
    height: 40px;
    padding: 0px 0px 0px 8px;
    border-radius: 4px;
}
.woocommerce .cart-collaterals .shipping_calculator .shipping-calculator-form .form-row input {
    border-radius: 4px;
}
/* woo checkout page */
...
.woocommerce-billing-fields p.form-row label {} .woocommerce-billing-fields p.form-row > *:not(label) {
    float: right;
    display: block;
    max-width: 70%;
    width: 100%;
...
/* woo shipping  */
.im_half_container.m_bottom_10 p {
	margin-left: 42%;
...
.shop_isotope_item .fp_item .im_half_container.m_bottom_10{
	display: inline-block;
	width: 100%;
	text-align: center;
}
...
.woocommerce-shipping-fields p.form-row label {} .woocommerce-shipping-fields p.form-row > *:not(label) {
    float: right;
    display: block;
    max-width: 70%;
    width: 100%;
...
table tbody tr:last-child th, table tfoot tr:last-child th {
    border-bottom: none;
}
.shop_table tr td.product-name, .shop_table tr td.product-total {
    border-bottom: 1px solid #bdc3c7;
}
...
/*table tr:first-child td, table tr:first-child th, table tr td:first-child, table tr th:first-child, table tr td:last-child, table tr th:last-child, table tr:last-child td{
	border: 1px solid #bdc3c7;
}*/
...
.woocommerce .login .form-row label input[name="rememberme"] {
    -webkit-appearance: checkbox;
    height: auto;
}
.woocommerce .login .required:after, .woocommerce .login .required_l:before {
    display: none;
}
.woocommerce .login .form-row input[name="login"], .woocommerce .lost_reset_password .form-row input[name="wc_reset_password"] {
    float: none;
    max-width: 187px;
    margin-bottom: 10px;
    /*margin-left: 32%;*/
...
.woocommerce .lost_reset_password input[name="wc_reset_password"] {} .woocommerce-error {
    margin-bottom: 15px;
    display: block;
}
...
.woocommerce-checkout .woocommerce > h2, .woocommerce-checkout .woocommerce header h2, .woocommerce-checkout .woocommerce header.title h3, .woocommerce-account .woocommerce > h2, .woocommerce-account .woocommerce header.title h3, .woocommerce-account .woocommerce header h2, .woocommerce-account .woocommerce h3 {
    padding: 12px 20px 14px 70px;
    font-size: 1.5em;
    position: relative;
    background: #f7f9f9;
...
.woocommerce-checkout .woocommerce > h2:before, .woocommerce-checkout .woocommerce header h2:before, .woocommerce-checkout .woocommerce header.title h3:before, .woocommerce-account .woocommerce > h2:before, .woocommerce-account .woocommerce header.title h3:before, .woocommerce-account .woocommerce header h2:before, .woocommerce-account .woocommerce h3:before {
    content: '\e914';
    font-family: "fontello";
    font-style: normal;
    font-weight: normal;
...
.woocommerce-checkout .woocommerce .order_item td {
    text-align: center;
}
.woocommerce-checkout .woocommerce .customer_details, .woocommerce-checkout .woocommerce .addresses address, .woocommerce-account .woocommerce .customer_details, .woocommerce-account .woocommerce .addresses address {
    line-height: 1.8;
}
.order-info mark {
    display: inline-block;
...
.woocommerce form .form-row > #billing_phone {  margin-bottom: 10px;}#order_comments {	float: right;    display: block;    max-width: 68%;    width: 100%;    border-radius: 4px;		margin-bottom: 10px;	    border: 1px solid #e1e4e6 !important;	    color: #666 !important;	    padding-left: 15px !important;}a.select2-choice{	float: right;    display: block;    max-width: 100%;    width: 100%;    min-height: 40px;    border-radius: 4px;		margin-bottom: 10px;		line-height: 40px;	    border: 1px solid #e1e4e6 !important;	    color: #666 !important;	    padding-left: 15px !important;	}
.woocommerce form .form-row > input[type="text"]:not(#calc_shipping_postcode),
.woocommerce form .form-row > input[type="password"],
.woocommerce form .form-row > input[type="email"],.woocommerce form .form-row > #billing_phone,
.woocommerce-checkout .woocommerce .form-row > .select2-container,
.woocommerce-account .woocommerce .form-row > *:not(label) {
    float: right;
    display: block;
    max-width: 68%;
    width: 100%;
...
.woocommerce-account .woocommerce .form-row .chosen-container-single .chosen-single {
    height: 40px;
    line-height: 40px;
    background: none;
    box-shadow: none;
...
.woocommerce-account .woocommerce .form-row .chosen-container-single .chosen-single div b {
    background-position: 0 10px !important;
}
.woocommerce-account .woocommerce .required:after {
    display: none;
}
.woocommerce-account .woocommerce input[name="save_account_details"], .woocommerce-account .woocommerce input[name="save_address"] {}
/* comment form submit */
...
.next_prev_area div.color_purple a:hover span{
    border-color: #41bedd;
}
...
.woocommerce .comment-form > p.comment-form-author, .woocommerce .comment-form > p.comment-form-email {
    width: 50%;
    float: left;
    padding-right: 10px;
    clear: right;
...
.woocommerce .comment-form > p.comment-form-author input, .woocommerce .comment-form > p.comment-form-email input {
    display: block;
    width: 100%;
    -webkit-border-radius: 4px;
    -moz-border-radius: 4px;
...
.woocommerce p.create-account input#createaccount {
    display: none;
}
/*sidebar cat, arcv*/

.widget_categories ul {} .widget_categories ul li, .widget_archive ul li {
    margin-bottom: 6px;
}
...
.widget_categories ul li a, .widget_archive ul li a, .woocommerce.widget_product_categories ul.categories_list > li > a{
    padding-left: 28px;
    color: #34383d;
    font-weight: 300;
    display: block;
...
.widget_categories ul li a:hover, .widget_archive ul li a:hover, .woocommerce.widget_product_categories ul.categories_list > li > a:hover, .woocommerce.widget_product_categories ul.categories_list > li > ul li a:hover{
    color: #41bedd;
}

.widget_categories ul li a:hover, .widget_archive ul li a:hover {} 

/*.widget_categories ul li a:before, .widget_archive ul li a:before, .woocommerce.widget_product_categories ul.categories_list > li > a:before {
    content: '\e9f7';
    font-family: "fontello";
    font-style: normal;
    font-weight: normal;
...
.widget_categories ul li a:hover:before, .widget_archive ul li a:hover:before, .woocommerce.widget_product_categories ul.categories_list > li > a:hover:before {
    color: #41bedd;
}


.woocommerce.widget_product_categories ul.categories_list > li > ul li a{
	color: #34383d;
    font-weight: 300;
    display: block;
}

.woocommerce.widget_product_categories ul.categories_list > li > ul li a:before{
	content: '\e9f7';
    font-family: "fontello";
    font-style: normal;
    font-weight: normal;
...
.fp_buttons .added_to_cart:hover {
...
.woocommerce .products figcaption .star-rating {
    float: right;
}
.woocommerce.post-type-archive-product .loop_product.shop_isotope_item, .woocommerce.tax-product_cat .loop_product.shop_isotope_item {
    border: 0;
    transition: width 0.4s ease-in 0s;
}
/* language menu */

.stripe_list > .menu-item-language {
    z-index: 15;
    margin-left: 0px;
    position: relative;
    display: inline-block;
...
.stripe_list .menu-item-language > a {
    display: inline-block;
    vertical-align: middle;
    line-height: 1;
    color: #34383d;
}
.header_top_part nav .hr_list.stripe_list{
    margin-top: 6px;
}
.header_top_part nav .hr_list.stripe_list > li{
    overflow: visible;
}
.header_top_part nav .hr_list.stripe_list .sub-menu,
.stripe_list ul.submenu-languages {
    min-width: 120px;    
    border-top-width: 2px;
    border-top-style: solid;
    border-left: 1px solid #f7f7f7;
...
.header_top_part nav .hr_list.stripe_list li:not(.menu-item-language) .sub-menu{
    top: 20px;
}
.header_top_part nav .hr_list.stripe_list li:not(.menu-item-language) .sub-menu > li{
    position: relative;
}
.header_top_part nav .hr_list.stripe_list li:not(.menu-item-language) .sub-menu .sub-menu{
    left: 100%;
    top: 0;
}
.header_top_part nav .hr_list.stripe_list .sub-menu li,
.stripe_list ul.submenu-languages li {
    margin: 0;
    border-top: 1px solid #ecf0f1;
    padding: 0;
}
.header_top_part nav .hr_list.stripe_list .sub-menu li a,
.stripe_list ul.submenu-languages li a {
    padding: 10px 10px;
    white-space: nowrap;
    width: 100%;
}
.header_top_part nav .hr_list.stripe_list .sub-menu li a:hover
.stripe_list ul.submenu-languages li a:hover {
    background: #f7f9f9;
    color: #41bedd;
}
.header_top_part nav .hr_list.stripe_list .sub-menu li:after,
.stripe_list ul.submenu-languages li:after {
    display: none;
}
.header_top_part nav .hr_list.stripe_list li:hover > .sub-menu,
.stripe_list .menu-item-language:hover ul.submenu-languages {
    -webkit-transform: rotate3d(0, 0, 0, 0deg);
    -moz-transform: rotate3d(0, 0, 0, 0deg);
    -o-transform: rotate3d(0, 0, 0, 0deg);
    -ms-transform: rotate3d(0, 0, 0, 0deg);
...
.header_top_part nav .hr_list.stripe_list .sub-menu > li.current-menu-item > a:after,
.stripe_list > .menu-item-language-current > a:after{
	content: '\e9f9';
	font-family: "fontello";
	font-style: normal;
	font-weight: normal;
...
.ie9 .stripe_list ul.submenu-languages{
	display: none;
}

.ie9 .stripe_list .menu-item-language:hover ul.submenu-languages{
	display: block;
}

.m_bottom_10.quote_content > i {
	display: block;
	height: 50px;
	overflow: hidden;
}

.product-details-conteiner .thumbnails_carousel .flex-direction-nav a.flex-prev{
	margin-left: -28px;
}

.product-details-conteiner .images .container_zoom_image > img{
	width: 100%;
	height: auto;
	margin: 0 auto;
	max-width: 100%;
...
.portfolio_isotope_container.without_text .portfolio_item {
	margin-bottom: 0;
}

.portfolio_isotope_container.with_text .portfolio_item{
	margin-top:30px;
}

.col-lg-9 .portfolio_isotope_container.three_columns.without_text .project_description{
	padding: 0px 20px;
}


.type-page figcaption > a ,
.blog_post figcaption > a {
	margin-top:10px;
}
.type-page h1,
.type-page h2,
...
.type-page > h1.fw_light,
.type-page > h2.fw_light,
.type-page > h3.fw_light,
.type-page > h4.fw_light,
.type-page > h5.fw_light,
.blog_post > h1.fw_light,
.blog_post > h2.fw_light,
.blog_post > h3.fw_light,
.blog_post > h4.fw_light,
.blog_post > h5.fw_light
{
    line-height: 1em;
}
...
.blog_post blockquote:not(.type_3):before, 
.blog_post blockquote:not(.type_3):after
{
    content: none;
}
.type-page blockquote ,
.blog_post blockquote:not(.type_3) 
{
...
.type-page ul.dotted_list,
.type-page ul.d_inline_m.fw_light,
.blog_post > p:last-child,
.blog_post ul.dotted_list,
.blog_post ul.d_inline_m.fw_light
{
    padding-left: 0;
    margin-bottom: 0;
}

.type-page .woocommerce ul.order_details,
.type-page .woocommerce-checkout-payment ul,
.type-page ul.hr_list,
.blog_post ul.slides,
.blog_post ul.flex-direction-nav
{
    list-style-type: none;
    padding-left: 0;
}
.woocommerce-cart .breadcrumbs span > a, .woocommerce-cart .breadcrumbs i, .woocommerce-cart .breadcrumbs span, .woocommerce-checkout .breadcrumbs span > a, .woocommerce-checkout .breadcrumbs i, .woocommerce-checkout .breadcrumbs span, .woocommerce-account .breadcrumbs span > a, .woocommerce-account .breadcrumbs i, .woocommerce-account .breadcrumbs span{
	color: #606366;
}

/*.widget_popular_posts_tab .tabs_nav.type_3 a {
	padding-left: 11px;
	padding-right: 11px;
}*/

.blog section .col-md-4.blog_listing:nth-child(3n+1), .blog section .col-md-3.blog_listing:nth-child(4n+1){
	clear: left;
}
...
.products .loop_product figcaption .add_to_cart_button i.icon-basket{
	margin-right: 9px;
}
...
.at-share-tbx-element .at-share-btn:hover span{
	color: #41bedd;
}

.addthis_32x32_style .at-share-btn:not(:last-child):after{
	content: ".";
	font-size: 25px;
	position: absolute;
	display: block;
...
.addthis_32x32_style .at15t_facebook, .addthis_32x32_style .at15t_twitter, .addthis_32x32_style .at15t_google_plusone_share, .addthis_32x32_style .at15t_pinterest_share{
	color: #d1d5d8;
	font-size: 1.125em;
	margin-right: 2px;
	background:none !important;
...
.addthis_32x32_style .at15t_facebook:before, .addthis_32x32_style .at15t_twitter:before, .addthis_32x32_style .at15t_google_plusone_share:before, .addthis_32x32_style .at15t_pinterest_share:before{
	content: '\e87c';
	font-family: "fontello";
	font-style: normal;
	font-weight: normal;
...
.addthis_32x32_style .at15t_facebook:before{
	content: '\e87c';
}
...
.addthis_32x32_style .at15t_google_plusone_share:before{
	content: '\e9a3';
}

.addthis_32x32_style .at15t_pinterest_share:before{
	content: '\e812';
}
...
form.variations_form.cart table.variations tbody td.value, form.variations_form.cart table.variations tbody td.value a.reset_variations, form.variations_form.cart table.variations tbody td.label{
	border:0;
	padding-right: 0;
...
form.variations_form.cart table.variations tbody td.value a.reset_variations{
	position: relative;
	display: inline-block;
	text-indent: -99999px;
}

form.variations_form.cart table.variations tbody td.value a.reset_variations:after{
	content: '\e8e3';
	font-family: "fontello";
	font-style: normal;
	font-weight: normal;
...
form.variations_form.cart table.variations tbody td.label label
{
	vertical-align: middle;
...
form.variations_form.cart table.variations tbody td.value select{
...
form.variations_form.cart table.variations tbody td.value select:focus{
	outline: none;
}
...
.owl-carousel.featured_products figure{
	padding-left: 15px;
	padding-right: 15px;
}
...
.woocommerce.widget_price_filter .price_slider_amount button, .woocommerce.widget_product_search form input[type="submit"], .yith-wcan-reset-navigation.button, .woocommerce .widget_layered_nav ul.yith-wcan-label li a, .woocommerce-page .widget_layered_nav ul.yith-wcan-label li a, .wishlist_table .product-add-to-cart .add_to_cart.button{
	border-color: #a255c4;
	background-color: transparent;
	min-height: 40px;
	padding: 7px 18px 7px;
...
.widget_search form.searchform input[type="submit"]:hover,
.woocommerce.widget_price_filter .price_slider_amount button:hover, .woocommerce.widget_product_search form input[type="submit"]:hover, .yith-wcan-reset-navigation.button:hover, .woocommerce .widget_layered_nav ul.yith-wcan-label li a:hover, .woocommerce-page .widget_layered_nav ul.yith-wcan-label li a:hover, .woocommerce .widget_layered_nav ul.yith-wcan-label li.chosen a, .woocommerce-page .widget_layered_nav ul.yith-wcan-label li.chosen a, .wishlist_table .product-add-to-cart .add_to_cart.button:hover{
	background: #a255c4;
	color: #fff;
	/*border-color: #a255c4;*/
	border-radius: 4px;
...
.woocommerce .widget_layered_nav ul.yith-wcan-color li, .woocommerce-page .widget_layered_nav ul.yith-wcan-color li, .woocommerce .widget_layered_nav ul.yith-wcan-color li, .woocommerce-page .widget_layered_nav ul.yith-wcan-color li{
	border-radius: 50%;
	border: 1px solid #bec3c7;
	display: block;
	overflow: hidden;
...
.woocommerce .widget_layered_nav ul.yith-wcan-color li a, .woocommerce-page .widget_layered_nav ul.yith-wcan-color li a, .woocommerce .widget_layered_nav ul.yith-wcan-color li span, .woocommerce-page .widget_layered_nav ul.yith-wcan-color li span, .woocommerce .widget_layered_nav ul.yith-wcan-color li a:hover, .woocommerce-page .widget_layered_nav ul.yith-wcan-color li a:hover{
	margin: 0;
	border:0;
	border-radius: 50%;
	display: inline-block;
...
.woocommerce .widget_layered_nav ul.yith-wcan-color li.chosen a, .woocommerce-page .widget_layered_nav ul.yith-wcan-color li.chosen a, .woocommerce .widget_layered_nav ul.yith-wcan-color li.chosen span, .woocommerce-page .widget_layered_nav ul.yith-wcan-color li.chosen span{
	 border: 0px solid #a255c4;
	 background-image: none; 
	 border-radius: 50%; 
}

.woocommerce .widget_layered_nav ul.yith-wcan-color li.chosen, .woocommerce-page .widget_layered_nav ul.yith-wcan-color li.chosen, .woocommerce .widget_layered_nav ul.yith-wcan-color li.chosen, .woocommerce-page .widget_layered_nav ul.yith-wcan-color li.chosen{
	 border-color: #363a3f;
	 
}


.woocommerce.widget_layered_nav .yith-wcan-list.yith-wcan{
...
.yith-wcan-select-wrapper ul.yith-wcan-select.yith-wcan li:not(:first-child){
...
.yith-wcan-list.yith-wcan li:last-child{
	border-bottom: 0;
}
...
.yith-wcan-list.yith-wcan li:before, .widget_categories ul li a:before, .widget_archive ul li a:before, .woocommerce.widget_product_categories ul.categories_list > li > a:before
{
	content: '\e9f7';
	font-family: "fontello";
	font-style: normal;
...
.woocommerce-wishlist.woocommerce #yith-wcwl-form > h2{}
...
.woocommerce-wishlist.woocommerce .yith-wcwl-share > h4{}
...
.woocommerce-wishlist.woocommerce .yith-wcwl-share li a:after{
	content: "";
	position: absolute;
	left: 0;
	right: 0;
...
.woocommerce-wishlist.woocommerce .yith-wcwl-share li a.facebook:after{
	content: '\e99a';
}

.woocommerce-wishlist.woocommerce .yith-wcwl-share li a.twitter:after{
	content: '\e9ad';
}

.woocommerce-wishlist.woocommerce .yith-wcwl-share li a.pinterest:after{
	content: '\e812';
}

.woocommerce-wishlist.woocommerce .yith-wcwl-share li a.googleplus:after{
	content: '\e9a3';
}

.woocommerce-wishlist.woocommerce .yith-wcwl-share li a.email:after{
	content: '\ea7d';
}
...
#sds-wishlist-success .close_popup{
	position: absolute;
	top: 0;
	right: 0;
	margin-top: -10px;
...
#sds-wishlist-success a:not(.close_popup){
	line-height: 2;
	margin-top: 10px;
}

[role="search"].type_4:not(.full_width) {
	max-width: 572px;
	width: 100%;
	z-index: 12;
}

[role="search"].type_4:not(.full_width) input[type="text"] {
	max-width: 350px;
        float: right;
}

.page.page-id-574 blockquote ~ div b.color_light, .page.page-id-519 blockquote ~ div b.color_light{
	color: #34383d;
}
...
.ils_compare_list .dataTables_wrapper{
	border: 1px solid #bdc3c7;
	border-radius: 4px;
	margin: 15px;
	overflow: hidden;
...
.ils_compare_list .dataTables_scrollBody{
	border-left: 1px solid #bdc3c7;
}

.ils_compare_list table.compare-list .remove td a .remove{
	vertical-align: middle;
}

.ils_compare_list table.compare-list tr.title td{
	color: #34383d;
	text-transform: none;
	font-size: 1em;
}

.ils_compare_list table.compare-list tr.price td
{
	padding-top: 4px;
	padding-bottom: 4px;
	text-decoration: none;
...
.ils_compare_list table.compare-list .add-to-cart td a {
	display: inline-block;
	margin: 10px 0;
	border: 1px solid;
	font-weight: normal;
...
.ils_compare_list table.compare-list tr.description td {
font-size: 0.9em;
padding: 10px 10px;
text-align: justify;
}
...
body.ils_compare_list .compare-list.dataTable tbody{
	border-right: 1px solid #bdc3c7;
}
...
#cboxBottomLeft, #cboxBottomRight, #cboxMiddleLeft, #cboxMiddleRight, #cboxTopLeft, #cboxTopCenter, #cboxTopRight{
	display: none;
}
...
.main_menu > li.ilsmegamenu > ul.sub_menu{
/*	width: 700px;
	max-width: 700px;
	min-width: initial;*/
...
.main_menu > li.ilsmegamenu:hover > ul.sub_menu{
	-webkit-transform: translateY(0px);
	-ms-transform: translateY(0px);
	-o-transform: translateY(0px);
	transform: translateY(0px);
...
.main_menu > li.ilsmegamenu > ul.sub_menu > li{
	width: 25%;
...
.main_menu > li.ilsmegamenu > ul.sub_menu > li > ul.sub_menu
{	left: 0;
	position: static;
	border:0;
	margin: 0;
...
.main_menu > li.ilsmegamenu > ul.sub_menu > li > ul.sub_menu > li:last-child{
	border-bottom: 0;
}

.main_menu > li.ilsmegamenu > ul.sub_menu > li > ul.sub_menu:before{
	display: none !important;
	/*height: 1px !important;*/
}

.main_menu > li.ilsmegamenu > ul.sub_menu > li > a{
	text-transform: uppercase;
	background: none;
	color: inherit;
}

.main_menu > li.ilsmegamenu > ul.sub_menu > li > a > i{
	display: none;
}
...
--------------------------------------*/
.product_onsale_color {
    color: #d94737 !important;
}
.countdown-row {
    clear: both;
    padding: 0 2px;
...
/* new updates for woocommerce 2.3 */
...
.woocommerce-checkout form ul li {
    list-style-type: none;
    padding: 0px 0px 5px;
}
...
.woocommerce > form div.coupon input#coupon_code{
    width: auto;
    clear: none;
    float: none;
    margin-bottom: 0;
...
.woocommerce > form input.button:not([name="woocommerce_checkout_place_order"]) {
    background:#F0F0F0;
    height: auto;
    line-height: normal;
    outline: medium none;
...
bg_gradient, .divider_type_2, .gradient_line, #qLbar {
  background: f9f5ba !important;
}.compare.button{display:none;}.t_align_c.d_xs_inline_b,.im_half_container.m_bottom_10,.w_md_full.animate_fctl, .im_half_container.m_bottom_10{text-align:center;}
.vc_child.tr_all.color_blue_hover.t_align_c{  position: absolute;color:#999;}
.compare.button_type_6{display:none;visibility:hidden;}
.add_to_cart_button.product_type_simple:hover, .add_to_cart_button.single_add_to_cart_button{color:#000 !important;}.product-details-conteiner .images .thumbnails_carousel, form.woocommerce-ordering, p.woocommerce-result-count{ display:none;visibility:hidden;}
.fp_images{text-align:center;}
.owl-item .col-lg-3{width:100% !important;}
.payment_box.payment_method_authorizeaim input {    width: 75%;    margin-bottom: 5px !important;    display: inline-block;	float: left !important;}.payment_box.payment_method_authorizeaim br {display:none;}.payment_box.payment_method_authorizeaim label {    width: 18% !important;    margin-right: 2% !important;    display: inline-block;	line-height: 45px !important;	    float: left !important;}.aimpay-row{    display: inline-block;	text-align:left;	width: 100% !important;}.create-account .checkbox {	padding-left: 35px !important;	    line-height: 12px !important;	}
...
body .images .thumbnails_carousel {
    clear: both;
    display: block !important;
    float: left;
    visibility: visible!important;
...
.images .thumbnails_carousel {
}
.images .thumbnails_carousel .flex-viewport {
    display: block;
    height: 150px !important;
}
.images .thumbnails_carousel a {
    float: left;
    width: auto;
}

.images .thumbnails_carousel .flex-viewport img {
    max-height: 120px;
    width: auto;
}
.images .thumbnails_carousel .flex-viewport a {
    max-width: 25%;
}
img.attachment-shop_catalog.size-shop_catalog.wp-post-image {
    display: block !important;
}
.fp_images a img:not(.attachment-shop_catalog) {
    display: none;
}
li.vc_tta-tab a {
    display: block !important;
...
.form-submit input[type="submit"] {
    border-color: #f9f5ba !important;  
    color: #000000 !important;
}.container.post-157 .u-column2.col-2 h2{		display: inline-block;    	width: 100%;	}.container.post-157 .u-column2.col-2 .register .woocommerce-Button.button{		border: 1px solid #000000;		float: none;	    max-width: 187px;	    margin-bottom: 10px;	}.product-name b {padding-right:5px;}

#out_of_stock{    font-size: 13px;		top: 112%;    display: inline-block;    margin-top: 30px;    position: absolute;    left: 0%;}
/**************** FROM FUNCTION.PHP START ****************/
    ...
    .add-rating-ip em.dashicons:before{

        vertical-align: middle;

    }

    .add-rating-ip,.rating-ip em.dashicons{
...
/**************** FROM FUNCTION.PHP END ****************/

.siButtonText { font-size: 18px !important};